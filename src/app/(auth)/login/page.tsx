                ...
                <div className="mt-12 w-full px-5">
                    ...
                    <Fragment>
                        ...
                        <TextInput
                            ...
                            type="text"
                            className={clsx(
                                'mt-2 flex h-10 w-full items-center rounded border border-gray-300 pl-3 text-sm font-normal text-gray-600 focus:border focus:border-sky-500/50 focus:outline-none',
                                {
                        ...
                        />
                        <p className="text-red-400 text-sm font-semibold mt-1 mb-5">{validationErrors?.email && "⚠️" + validationErrors?.email}</p>
                    </Fragment>
                    <Fragment>
                        <label
                            htmlFor="password"
                        ...
                        <div className="relative mb-2 mt-2">
                            ...
                            />
                            <p className="text-red-400 text-sm font-semibold mt-1 mb-5">{validationErrors?.password && "⚠️" + validationErrors?.password}</p>
                        </div>
                    </Fragment>
                    <Button
                        type="submit"
