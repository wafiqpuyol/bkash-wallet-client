...
import { StatusButtonGroup } from '@/components/uptime/StatusButtonGroup';
import { StatusTable } from '@/components/uptime/StatusTable';
import { useUptimeView } from '@/hooks/uptime/useUptimeView';
...
const View: React.FC<ViewProp> = ({ params }) => {
    const {
        limit,
        duration,
        monitor,
