            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Our OctoProb monitoring service helps you track uptime of your services in real-time, ensuring high availability and
...
const Footer = () => (
  <footer className="bg-gray-900 text-white py-8 mt-auto">
    <div className="max-w-7xl mx-auto px-4">
      <p className="text-center">&copy; {new Date().getFullYear()} OctoProb Dashboard. All rights reserved.</p>
    </div>
  </footer>
);
