...
import { IMonitorDocument } from "@/interfaces/monitor";
import React, { FC, ReactElement } from "react";
import { FaPause, FaPlay, FaPencilAlt, FaTrashAlt } from "react-icons/fa";
import { useHomeTableBtnGroup } from "@/hooks/status/useHomeTableBtnGroup";

interface HomeTableBtnGroupProps {
    monitor: IMonitorDocument;
}

export const HomeTableBtnGroup: FC<HomeTableBtnGroupProps> = ({
    monitor,
}): ReactElement => {
    const {
        toggleUserMonitor,
