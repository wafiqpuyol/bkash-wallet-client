...
import { IPagination } from '@/interfaces/monitor';
import { ISSLInfo, ISSLMonitorDocument, sslDefaultInfoData } from '@/interfaces/ssl';
import clsx from 'clsx';
import { useSSLTable } from '@/hooks/ssl/useSSLTable';
...
export const SSLTable: React.FC<SSLTableProps> = ({ monitors, limit }) => {
