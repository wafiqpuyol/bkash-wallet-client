...
import { ISSLMonitorDocument, SSLModalDataProp } from '@/interfaces/ssl';
import { FaCheckCircle } from 'react-icons/fa';
import { useSSLInfoModal } from '@/hooks/ssl/useSSLInfoModal';

interface SSLInfoModalProp {
    monitor: ISSLMonitorDocument; onClose: () => void
}

export const SSLInfoModal: React.FC<SSLInfoModalProp> = ({ monitor, onClose }) => {
    const {
        sslInfo,
        hostInfo,
        subjectInfo,
...
const CertInfo = ({ title, body }: { title: string, body: SSLModalDataProp[] }) => {
    return (
