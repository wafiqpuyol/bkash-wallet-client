...
import { IStatusPageButtonGroup } from '@/interfaces/monitor';
import clsx from 'clsx';
import { FaPause, FaPencilAlt, FaPlay, FaTrashAlt } from 'react-icons/fa';

export const StatusButtonGroup: React.FC<IStatusPageButtonGroup> = ({ monitor, toggleUserMonitor, editMonitor, deleteUserMonitor }) => {
    return (
        <>
            {monitor && (
