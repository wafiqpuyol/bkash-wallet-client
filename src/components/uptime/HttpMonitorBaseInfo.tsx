...
import { MonitorBaseInfoProps } from '@/interfaces/monitor';
...
export const HttpMonitorBaseInfo: React.FC<MonitorBaseInfoProps> = ({ monitorInfo, notifications, validationErrors, setMonitorInfo }) => {
    return (
        <>
