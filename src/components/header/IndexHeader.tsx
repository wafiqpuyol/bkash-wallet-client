        ...
        <div className="relative z-[120] w-full border-b bg-white shadow-2xl shadow-gray-600/5 backdrop-blur dark:shadow-none" ref={headerRef}>
            <div className="m-auto px-6 xl:container md:px-12 lg:px-6">
                <div className="relative py-4 flex flex-wrap items-center justify-between gap-6 md:gap-0">
                    ...
                    <div className={clsx(
                        'nav menu w-full cursor-pointer z-50 flex-wrap items-center justify-end space-y-8 rounded-3xl border border-gray-100 bg-white p-6 shadow-2xl lg:m-0 lg:flex lg:w-6/12 lg:space-y-0 lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none',
                        {
